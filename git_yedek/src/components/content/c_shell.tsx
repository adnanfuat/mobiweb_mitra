import s from "./c_shell.module.css";
...
import { C_Layout } from "./c_layout";



export default function  C_Shell (props) { 
        ...
        const [tab, settab] = useState(1);      
          ...
          return (
              <C_Layout  title={advert?.title_tr} parents={parents}  bigbigparent_key={bigbigparent_key}  pagetype="richcontent" urlprefix_parents={"rs"}>     
