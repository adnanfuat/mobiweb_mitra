...
export const SingleSelect = (props)  => {
    let { id, name, label, value, formik,  options, fullwidth, style,triggerFuncs, 
  ...
  return (
    <div className={s.shell} style={{width: fullwidth ? "100%" : "auto"}}>
          ...
          <select className={s.select}  name={name} value={value} onChange={formik?.handleChange} style={style}>
