        ...
        <div className={s.blogsWr}>
                                ...
                                <Link href="#">
                                        <div className={s.blogWr}> 
                                            ...
                                            <div className={s.blogImage}><Image src={"/themes/vitalis/blog1.jpg"} width={580} height={435}/></div>                                                                     
                                ...
                                <Link href="#">
                                        <div className={s.blogWr}> 
                                            ...
                                            <div className={s.blogImage}><Image src={"/themes/vitalis/blog2.jpg"} width={580} height={435}/></div>                                                                     
                                            <div className={s.blogButton}>Devamı</div>                                
                                        </div>
                                </Link>
                                ...
                                <Link href="#">
                                        <div className={s.blogWr}> 
                                            ...
                                            <div className={s.blogImage}><Image src={"/themes/vitalis/blog3.jpg"} width={580} height={435}/></div>                                                                     
                                            <div className={s.blogButton}>Devamı</div>                                
                                        </div>
                                </Link>
