...
export const Advert_VisitorMode_MetaData  =  (props:IProps) => {
  ...
  let img =  imgs_source+"/"+advert?.img_tr;
                  ...
                  <Head> 
                        ...
                        <meta name="description" content={description ? description : title } />
                            ...
                            <script type="application/ld+json" dangerouslySetInnerHTML={{__html: `
                                ...
                                "url":  "${`${process.env.NEXT_PUBLIC_URL}/r/${advert?.slug_tr}/${description}`}",
                                ...
                                "articleBody": "${description ?? title}",
                                  ...
                                  "@type": "Person",
                                  "name": "Steve",
                                  "url":  "${`${process.env.NEXT_PUBLIC_URL}/r/${advert?.slug_tr}/${advert?.id}`}",
                                }
                                }
                            `}}>
                            </script>
                        ...
                        <meta name="og_url" property="og:url" content={`${process.env.NEXT_PUBLIC_URL}/r/${advert?.slug_tr}/${advert?.id}`}/>
