...
export default async function RootLayout({
  ...
  let resdata =   await fetch(`${process.env.API_URL}/api/graphql`, { //process.env.NEXT_PUBLIC_API_URL
    method: "POST",
    ...
    let fileobjects =   await fetch(`${process.env.API_URL}/api/graphql`, { //process.env.NEXT_PUBLIC_API_URL
      method: "POST",
      headers: { "Content-Type": "application/json", },
      body: JSON.stringify({
